...
... when R2D2 extended his droid arm and:

picked up the [light sabre](./r2d2-lightsabre/lightsabre.md)

picked up and threw a [thermal detonator](./r2d2-thermal/thermal.md) to Han Solo

picked up the [circuit](./r2d2-circuit/circuit.md) placing it into the red slot
