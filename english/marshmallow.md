...
This story started with little to nothing, and has grown to a wild tale of
dreams, mythical creatures, and a maze of loops. The story really starts when
you:

Decided to go the the [forest](forest/forest.md).
Decided to [run out the door](run_out_the_door/run_out_the_door.md).
Decided to [write a symphony](write-a-symphony/symphony.md).
